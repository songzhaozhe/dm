...
_index_list, _feature_list, label_list = prepare_data_for_generator(train_files)
epochstep = int(TOTAL_EPOCH * len(_index_list) / epoch_num / batch_size)
model.fit_generator(data_generator(_index_list, _feature_list, label_list, batch_size), epochs=epoch_num,
...
score = model.evaluate_generator(data_generator(index_list, feature_list, label_list, batch_size, shuffle=False),
                                 epochstep)
print(score)
